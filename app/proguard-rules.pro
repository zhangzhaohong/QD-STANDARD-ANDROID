...
#-keep class com.autumn.reptile.framework {*;}#不要混淆我们的入口类
#----------------------------------------------------------------------------
...
#---------------------------------实体类---------------------------------
#修改成你对应的包名
#-keep class com.autumn.reptile.framework.** { *; }
...
#下面中括号的地方需要要填你的包名
-keep public class com.autumn.reptile.R$*{
...
#-keep class com.youth.xframe.** { *; }
#-keep interface com.youth.xframe.** { *; }
-dontwarn com.youth.xframe.**
...
-keep class cn.hotapk.fastandrutils.** { *; }
-keep interface cn.hotapk.fastandrutils.** { *; }
-dontwarn cn.hotapk.fastandrutils.**

-keep class com.autumn.framework.music.** { *; }
-keep interface com.autumn.framework.music.** { *; }
-dontwarn com.autumn.framework.music.**

-keep class com.ywl5320.** { *; }
-keep interface com.ywl5320.** { *; }
-dontwarn com.ywl5320.**

-keep class me.wcy.lrcview.** { *; }
-keep interface me.wcy.lrcview.** { *; }
-dontwarn me.wcy.lrcview.**
