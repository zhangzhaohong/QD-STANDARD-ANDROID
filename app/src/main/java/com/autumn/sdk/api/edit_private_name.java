...
public class edit_private_name {

    public static String edit_private_name(Context context, String account, String password, String new_private_name) {

        String key = key_manager.key;

        StringBuffer sb = new StringBuffer();

        String urlString = context.getString(R.string.server_url) + "api/edit_private_name.php?account="+getURLEncoderString(account)+"&password="+getURLEncoderString(password)+"&new_private_name="+getURLEncoderString(new_private_name);
                        ...
                        try {
                            ...
                            try {
                                ...
                                if(decrypt.equals("-1")){
                                    ...
                                    return context.getString(R.string.edit_success);
                                    ...
                                    return context.getString(R.string.edit_error_null);
                                }else if(decrypt.equals("-7")){
                                    return context.getString(R.string.edit_error_username_not_exist);
                                }else if(decrypt.equals("-9")){
                                    return context.getString(R.string.edit_write_failed);
                                }
