...
public class beta_application {
    ...
    public static String beta_application(Context context, String account, String password, String appkey) {
        ...
        String urlString = context.getString(R.string.server_url) + "api/beta_application.php?account="+getURLEncoderString(account)+"&password="+getURLEncoderString(password)+"&app_key="+getURLEncoderString(appkey);
                        ...
                        try {
                            ...
                            try {
                                ...
                                if(decrypt.equals("-1")){
                                    ...
                                    try {
                                        String beta_key = jsonObject.getString("beta_key");

                                        if (beta_key == null || beta_key.equals(""))
                                            return context.getString(R.string.beta_application_application_full);

                                        beta_manager.beta_private_key = DesUtil.decrypt(DesUtil.decrypt(beta_key,key),key);
