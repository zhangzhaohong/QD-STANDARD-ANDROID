...
public class notice {
    ...
    public static String notice(Context context, String app_key, String version) {
                        ...
                        try {
                            ...
                            try {
                                ...
                                if(decrypt.equals("-1")){
                                    ...
                                    try {
                                        String app_notice_version = DesUtil.decrypt(jsonObject.getString("version"),key);
                                        String app_notice_content =DesUtil.decrypt(jsonObject.getString("notice"),key);
                                        //LogUtil.i(user_key);

                                        notice_manager.app_notice_version = app_notice_version;
                                        notice_manager.app_notice_content = app_notice_content;
    ...
    public static String beta_notice(Context context, String app_key, String version, String user_key) {
    ...
    public static String debug_notice(Context context, String app_key, String version, String user_key, String device_code) {
