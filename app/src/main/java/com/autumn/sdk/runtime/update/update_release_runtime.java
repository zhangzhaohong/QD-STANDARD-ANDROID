...
import com.autumn.sdk.api.update_release;
...
public class update_release_runtime implements Runnable {
    ...
    public update_release_runtime(Handler h1, Context context) {
        this.handler = h1;
        this.context = context;
        this.package_name = DesUtil.encrypt(context.getString(R.string.app_package_name),key);
    ...
    public void run() {
        ...
        String result = null;
        result = update_release.update(context, package_name);
