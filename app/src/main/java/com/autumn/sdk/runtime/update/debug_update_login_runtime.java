...
import com.autumn.sdk.api.update;
...
public class debug_update_login_runtime implements Runnable {
    ...
    public debug_update_login_runtime(Handler h1, Context context, String user_key, String device_code) {
        this.handler = h1;
        this.context = context;
        this.app_key = DesUtil.encrypt(DesUtil.encrypt(context.getString(R.string.app_debug_key),key),key);
        this.version = DesUtil.encrypt(context.getString(R.string.app_build),key);
        this.user_key = DesUtil.encrypt(DesUtil.encrypt(user_key,key),key);
        this.device_code = DesUtil.encrypt(DesUtil.encrypt(device_code,key),key);
    ...
    public void run() {
        ...
        String result = null;
        result = update.debug_update(context, app_key, version,user_key,device_code);
