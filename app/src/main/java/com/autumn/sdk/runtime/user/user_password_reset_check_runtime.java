...
public class user_password_reset_check_runtime implements Runnable{
    ...
    public user_password_reset_check_runtime(Handler h1, Context context,String account,String user_birthday,String user_email) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = user_password_reset.password_reset_check(context,account,user_birthday,user_email);
