...
public class content_runtime implements Runnable {
    ...
    public content_runtime(Handler h1, Context context, String app_key, String build) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = content_downloader.content_download(context, app_key, version);
