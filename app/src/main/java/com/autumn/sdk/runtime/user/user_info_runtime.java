...
import com.autumn.sdk.api.user_info;
...
public class user_info_runtime implements Runnable {
    ...
    public user_info_runtime(Handler h1, Context context, String account) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = user_info.info(context, account);
