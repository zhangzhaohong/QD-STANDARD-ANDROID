...
public class check_sign_runtime implements Runnable {
    ...
    public check_sign_runtime(Handler h1, Context context, String account, String password,String user_key) {
        this.handler = h1;
        this.context = context;
        this.account = DesUtil.encrypt(account,key);
        this.password = DesUtil.encrypt(DesUtil.encrypt(password,key),key);
        this.type = DesUtil.encrypt("check_sign",key);
    ...
    public void run() {
        ...
        String result = null;
        result = user_sign.check_sign(context, account, password,type,user_key);
