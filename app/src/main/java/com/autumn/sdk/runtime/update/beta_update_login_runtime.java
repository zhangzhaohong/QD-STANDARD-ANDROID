...
public class beta_update_login_runtime implements Runnable {
    ...
    public beta_update_login_runtime(Handler h1, Context context, String user_key) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = update.beta_update(context, app_key, version,user_key);
