package com.autumn.sdk.runtime.notice;
...
import com.autumn.sdk.api.notice;
...
public class debug_notice_runtime implements Runnable {
    ...
    public debug_notice_runtime(Handler h1, Context context) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = notice.debug_notice(context, app_key, version,user_key,device_code);
