...
import com.autumn.sdk.api.user_private_name;
...
public class get_private_name_runtime implements Runnable {
    ...
    public get_private_name_runtime(Handler h1, Context context,String username) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = user_private_name.get_private_name(context,account);
        //LogUtil.i(result);
