...
import com.autumn.sdk.api.user_register;
...
public class user_register_runtime implements Runnable {
    ...
    public user_register_runtime(Handler h1, Context context,String account,String password,String private_name,String user_birthday,String user_email,String user_imei) {
        this.handler = h1;
        this.context = context;
        this.account = DesUtil.encrypt(account,key);
        this.password = DesUtil.encrypt(DesUtil.encrypt(password,key),key);
        this.private_name = DesUtil.encrypt(private_name,key);
        this.user_birthday = DesUtil.encrypt(user_birthday,key);
        this.user_email = DesUtil.encrypt(user_email,key);
        this.user_imei = DesUtil.encrypt(DesUtil.encrypt(user_imei,key),key);
    }
    ...
    public void run() {
        ...
        String result = null;
        result = user_register.register(context,account,password,private_name,user_birthday,user_email,user_imei);
