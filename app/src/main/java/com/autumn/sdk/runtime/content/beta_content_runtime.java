...
public class beta_content_runtime implements Runnable {
    ...
    public beta_content_runtime(Handler h1, Context context, String app_key, String build) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = null;
        result = content_downloader.beta_content_download(context, app_key, version, user_key);
