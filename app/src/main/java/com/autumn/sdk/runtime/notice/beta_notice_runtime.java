...
public class beta_notice_runtime implements Runnable {
    ...
    public beta_notice_runtime(Handler h1, Context context) {
        this.handler = h1;
        this.context = context;
        this.app_key = DesUtil.encrypt(DesUtil.encrypt(context.getString(R.string.app_beta_key),key),key);
    ...
    public void run() {
        ...
        String result = null;
        result = notice.beta_notice(context, app_key, version,user_key);
