...
import com.autumn.framework.update.utils.IOUtils;
import com.autumn.framework.update.utils.InstallUtil;
import com.autumn.framework.update.utils.SystemManager;
...
public class DownloadService extends Service {
    ...
    private class DownloadFinishReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            @SuppressLint({"NewApi", "LocalSuppress"}) String apkPath = mApkPaths.get(completeDownloadId);
