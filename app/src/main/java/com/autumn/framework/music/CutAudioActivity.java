...
public class CutAudioActivity extends AppCompatActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        source = Environment.getExternalStorageDirectory().getPath() + MyApplication.getAppContext().getString(R.string.files_path) + "/shared/Other/" + key;
        ...
        wlMusic.setOnPreparedListener(new OnPreparedListener() {
            ...
            public void onPrepared() {
                if(type == 1)
                {
                    wlMusic.cutAudio(start, end, Environment.getExternalStorageDirectory().getPath() + MyApplication.getAppContext().getString(R.string.files_path) + "/shared/Other", "cut.aac");
                }
                else if(type == 2)
                {
