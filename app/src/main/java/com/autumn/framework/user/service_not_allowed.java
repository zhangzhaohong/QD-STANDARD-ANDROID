...
public class service_not_allowed extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_service_not_allowed);
        ...
        tipDialog = new QMUITipDialog.Builder(service_not_allowed.this)
                .setIconType(QMUITipDialog.Builder.ICON_TYPE_LOADING)
                .setTipWord("正在加载")
                .create(false);
        tipDialog.show();

        new Thread(new content_runtime(h1, service_not_allowed.this, getString(R.string.service_not_allowed_key), getString(R.string.app_build))).start();
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(service_not_allowed.this, LoginActivity.class);
                startActivity(intent);
                AtyTransitionUtil.exitToRight(service_not_allowed.this);
