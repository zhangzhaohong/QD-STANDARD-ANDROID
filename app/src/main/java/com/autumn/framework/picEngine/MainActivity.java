package com.autumn.framework.picEngine;
...
import com.autumn.framework.picEngine.glide.GlideV4Engine;
...
public class MainActivity extends AppCompatActivity {
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pic_shower_test);
    ...
    private void chooseImage() {
        Matisse.from(MainActivity.this)
            ...
            .capture(true)
            .captureStrategy(new CaptureStrategy(true, "com.autumn.reptile.fileProvider", "com.autumn.reptile/PicDownload"))
            .countable(true)
            .maxSelectable(30)
