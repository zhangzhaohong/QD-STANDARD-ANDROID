...
import com.autumn.framework.entertainment.http.NetWork_Connecter_Music_Banner;

/**
 * Created by zhang on 2018/3/26.
 */

public class Entertainment_Music_Banner_runtime implements Runnable {
    ...
    public Entertainment_Music_Banner_runtime(Handler h1, String service) {
        this.handler = h1;
    ...
    public void run() {
        ...
        String result = "";
        result = NetWork_Connecter_Music_Banner.music_banner_connect(service);
