...
import com.autumn.framework.entertainment.http.NetWork_Connecter_Daily;

/**
 * Created by zhang on 2018/3/26.
 */

public class Entertainment_Daily_runtime implements Runnable {
    ...
    public Entertainment_Daily_runtime(Handler h1) {
        this.handler = h1;
    }
    ...
    public void run() {
        ...
        String result = "";
        result = NetWork_Connecter_Daily.daily_connect();
