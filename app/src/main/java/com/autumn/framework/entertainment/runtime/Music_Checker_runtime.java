...
import com.autumn.framework.entertainment.http.Music_checker;

/**
 * Created by zhang on 2018/3/26.
 */

public class Music_Checker_runtime implements Runnable {
    ...
    public Music_Checker_runtime(Handler h1, String url) {
        this.handler = h1;
        this.url = url;
    }
    ...
    public void run() {
        ...
        String result = "";
        result = Music_checker.music_check_avaliable(url);
        if (result.equals("访问成功"))
            result = Music_checker.music_check_url_avaliable();
