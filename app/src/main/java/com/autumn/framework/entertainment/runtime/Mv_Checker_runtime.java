...
import com.autumn.framework.entertainment.http.Mv_checker;

/**
 * Created by zhang on 2018/3/26.
 */

public class Mv_Checker_runtime implements Runnable {
    ...
    public Mv_Checker_runtime(Handler h1, String url) {
        this.handler = h1;
        this.url = url;
    }
    ...
    public void run() {
        ...
        String result = "";
        result = Mv_checker.mv_check_avaliable(url);
