...
public class NetWork_Connecter_Music_Format {
    ...
    public static String music_connect(String service, String content, String type, int page) {
        ...
        String urlString = Host_manager.getMusicHost() + "/" + getURLEncoderString(service) + "/search?keyword=" + getURLEncoderString(content) + "&type=" + getURLEncoderString(type) + "&pageSize=10&page=" + getURLEncoderString(String.valueOf(page)) + "&format=1";
                        ...
                        try {
                            switch (service){
                                ...
                                case "kuwo":
                                    ...
                                    break;
                                case "migu":
                                    NetWork_Analysis_Music_Migu.Startprocessing(page, sb.toString());
                                    break;
                                case "baidu":
