...
public class Mv_checker {

    private static String url_302;

    public static String mv_check_avaliable(String urlString) {
            ...
            try {
                ...
                try {
                    ...
                    if (codes == 200) {
                        ...
                        Music_player_manager.setMvCheckResponse(sb.toString());
                        return "访问成功";
                    }else {
                        return "无法访问网站" + codes;
