...
public class NetWork_Connecter_Music_Banner {

    public static String music_banner_connect(String service) {
        ...
        String urlString = Host_manager.getHotMusicHost() + "/" + getURLEncoderString(service) + "/banner";
                ...
                try {
                    ...
                    if (400 >= codes) {
                        ...
                        while ((str = br.readLine()) != null) {
                            sb.append(str);
                            LogUtil.d("NetWork_Connecter_Music_Banner\n" +
                                    "{\n" +
                                    "Url\n[" + urlString +
                                    "]\n" +
                                    "Data\n[" + sb.toString() +
                        ...
                        try {
                            ...
                            NetWork_Analysis_Music_Banner.Startprocessing(sb.toString());
