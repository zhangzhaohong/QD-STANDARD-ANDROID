 ...
 * @描述 调色板网格适配器
 */
public class PaletteGridAdapter_7 extends RecyclerView.Adapter<PaletteGridAdapter_7.PaletteGridViewHolder> {
    ...
    public static void refreshData() {
        name =Data_manager_7_hotMusic.getName();
        singer = Data_manager_7_hotMusic.getSinger();
        imgURL = Data_manager_7_hotMusic.getBackground();
        url = Data_manager_7_hotMusic.getUrl();
    }
    ...
    class PaletteGridViewHolder extends RecyclerView.ViewHolder {
        ...
        private void jump_to_Player() {
            if (url[getAdapterPosition()] == null){
                ...
                if (url[getAdapterPosition()].equals("")) {
                    ...
                    bundle.putString("from","HotMusic");
        ...
        private void getInfo(int id) {
            ...
            if (Music_player_manager.getHot_music_service() == null){
                ...
                switch (Music_player_manager.getHot_music_service()){
                    case "0":
