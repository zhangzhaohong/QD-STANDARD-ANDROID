 ...
 * @描述 调色板网格适配器
 */
public class PaletteGridAdapter_3 extends RecyclerView.Adapter<PaletteGridAdapter_3.PaletteGridViewHolder> {

    final String[] imgURL = Data_manager_3.getBackground();
    final String[] name = Data_manager_3.getName();
    final String[] url = Data_manager_3.getUrl();
