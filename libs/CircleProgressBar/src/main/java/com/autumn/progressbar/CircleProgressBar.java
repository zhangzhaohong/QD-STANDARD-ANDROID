package com.autumn.progressbar;
...
public class CircleProgressBar extends ProgressBar {
    ...
    private static final float DEFAULT_PROGRESS_TEXT_SIZE = 30.0f;
    private static final float DEFAULT_PROGRESS_STROKE_WIDTH = 1.0f;

    private static final String COLOR_FFF2A670 = "#17F1EF";
    private static final String COLOR_FFD3D3D5 = "#303F9F";
    ...
    private void initFromAttributes(Context context, AttributeSet attrs) {
        ...
        mProgressTextSize = a.getDimensionPixelSize(R.styleable.CircleProgressBar_progressbar_text_size, UnitUtils.dip2px(getContext(), DEFAULT_PROGRESS_TEXT_SIZE));
        ...
        mProgressTextColor = a.getColor(R.styleable.CircleProgressBar_progressbar_text_color, Color.parseColor(COLOR_FFF2A670));
